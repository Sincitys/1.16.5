...
public class AshFruitBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:ash_fruit")
	public static final Block block = null;

	public AshFruitBlock(ProjectMoiraModElements instance) {
		super(instance, 55);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == AshwoodLogBlock.block
