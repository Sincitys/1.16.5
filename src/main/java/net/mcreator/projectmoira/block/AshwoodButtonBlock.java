...
public class AshwoodButtonBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:ashwood_button")
	public static final Block block = null;

	public AshwoodButtonBlock(ProjectMoiraModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("ashwood_button");
		}
