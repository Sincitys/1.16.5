...
public class AshwoodFenceBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:ashwood_fence")
	public static final Block block = null;

	public AshwoodFenceBlock(ProjectMoiraModElements instance) {
		super(instance, 36);
	}
