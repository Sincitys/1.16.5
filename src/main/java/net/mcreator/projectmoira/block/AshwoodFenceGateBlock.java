...
public class AshwoodFenceGateBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:ashwood_fence_gate")
	public static final Block block = null;

	public AshwoodFenceGateBlock(ProjectMoiraModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ashwood_fence_gate");
		}
