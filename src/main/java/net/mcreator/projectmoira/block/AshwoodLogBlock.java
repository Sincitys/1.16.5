...
public class AshwoodLogBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:ashwood_log")
	public static final Block block = null;

	public AshwoodLogBlock(ProjectMoiraModElements instance) {
		super(instance, 31);
	}
