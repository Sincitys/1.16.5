...
public class AshwoodPlanksBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:ashwood_planks")
	public static final Block block = null;

	public AshwoodPlanksBlock(ProjectMoiraModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ashwood_planks");
		}
