...
public class AshwoodPressurePlateBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:ashwood_pressure_plate")
	public static final Block block = null;

	public AshwoodPressurePlateBlock(ProjectMoiraModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("ashwood_pressure_plate");
		}
