...
public class AshwoodSlabBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:ashwood_slab")
	public static final Block block = null;

	public AshwoodSlabBlock(ProjectMoiraModElements instance) {
		super(instance, 35);
	}
