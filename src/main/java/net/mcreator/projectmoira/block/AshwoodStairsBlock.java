...
public class AshwoodStairsBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:ashwood_stairs")
	public static final Block block = null;

	public AshwoodStairsBlock(ProjectMoiraModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ashwood_stairs");
		}
