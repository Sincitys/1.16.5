...
public class AshwoodWoodBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:ashwood_wood")
	public static final Block block = null;

	public AshwoodWoodBlock(ProjectMoiraModElements instance) {
		super(instance, 30);
	}
