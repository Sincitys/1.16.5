...
public class DagrumBlockBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:dagrum_block")
	public static final Block block = null;

	public DagrumBlockBlock(ProjectMoiraModElements instance) {
		super(instance, 3);
	}
