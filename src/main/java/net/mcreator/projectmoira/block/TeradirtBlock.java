...
public class TeradirtBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:teradirt")
	public static final Block block = null;

	public TeradirtBlock(ProjectMoiraModElements instance) {
		super(instance, 23);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("project_moira:teradirt_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("teradirt"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("project_moira:teradirt"), configuredFeature);
		}
	}
