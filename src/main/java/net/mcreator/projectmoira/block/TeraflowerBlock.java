...
public class TeraflowerBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:teraflower")
	public static final Block block = null;

	public TeraflowerBlock(ProjectMoiraModElements instance) {
		super(instance, 24);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SPEED, 100, Block.Properties.create(Material.PLANTS, MaterialColor.GRASS).doesNotBlockMovement().sound(SoundType.PLANT)
