...
public class TeragrassBlock extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:teragrass")
	public static final Block block = null;

	public TeragrassBlock(ProjectMoiraModElements instance) {
		super(instance, 54);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("project_moira:teragrass_match"), () -> CustomRuleTest.codec);
