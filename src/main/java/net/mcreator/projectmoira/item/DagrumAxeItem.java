...
public class DagrumAxeItem extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:dagrum_axe")
	public static final Item block = null;

	public DagrumAxeItem(ProjectMoiraModElements instance) {
		super(instance, 8);
	}
