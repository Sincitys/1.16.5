...
public class DagrumHoeItem extends ProjectMoiraModElements.ModElement {
	@ObjectHolder("project_moira:dagrum_hoe")
	public static final Item block = null;

	public DagrumHoeItem(ProjectMoiraModElements instance) {
		super(instance, 11);
	}
